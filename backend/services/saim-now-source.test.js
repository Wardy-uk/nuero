...
/**
 * What SAiM's Now screen must keep doing with focus sessions.
 *
 * `saim/app/src/views/Now.jsx` is mounted by the phone, the laptop (Electron loads the
...
const NOW = path.join(__dirname, '..', '..', 'saim', 'app', 'src', 'views', 'Now.jsx');
...
test('positive control: this is the SAiM Now screen, and it already runs sessions', () => {
