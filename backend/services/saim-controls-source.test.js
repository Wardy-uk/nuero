...
/**
 * SAiM screens that must keep telling the truth about three things.
 *
 *   Controls              — what SAiM has quietened, and the way to turn it back on.
...
const APP = path.join(__dirname, '..', '..', 'saim', 'app', 'src');
