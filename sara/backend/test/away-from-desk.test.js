...
test('the desk sensor alone decides whether SARA shows', () => {
...
test('only the laptop hearing him is "away from the desk", not SARA', () => {
...
test('the laptop can never put SARA on the screen by itself', () => {
  const d = offsiteDisplayState('office', desk(false), { mobile: laptop(true), meeting: meeting('2026-09-14T14:30:00+01:00') });
