"""SARA — NEURO's brain as Home Assistant's conversation agent (13 Sep 2026).
...
template. Every "ask SARA" therefore answered *"Nothing came back from the
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Set up SARA from a config entry."""
