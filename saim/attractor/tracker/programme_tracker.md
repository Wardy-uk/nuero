...
- SAiM is a persistent operating layer, not a chatbot-first product.
- There is one shared SAiM brain and shared state across embodiments.
...
- SAiM UI must remain view-based: one state, many views.
...
- `nuero` is the authoritative SAiM workspace.
