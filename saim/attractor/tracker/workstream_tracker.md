...
- Status: Converged
- Goal: Create an always-on SAiM dashboard system with interchangeable views
...
- Goal: Add the next real SAiM views on top of the converged many-views architecture
...
- Status: Converged
- Goal: Feed Home Assistant telemetry into SAiM's shared state model without changing view ownership
...
- Status: Ready for build
- Goal: Infer what Nick is doing now and what view SAiM would recommend, using the converged state + telemetry seam
