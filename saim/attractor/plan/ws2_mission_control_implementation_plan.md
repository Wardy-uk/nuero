...
Deliver the first usable SAiM screen while establishing a reusable screen/view architecture that stays subordinate to one shared state model.
...
- create `scripts/start-saim.sh`
- create `desktop/SAiM.desktop`
