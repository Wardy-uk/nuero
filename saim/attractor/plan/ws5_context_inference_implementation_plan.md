...
Prove that SAiM can derive a bounded understanding of current context from its converged state and telemetry seam without turning inference into a second state owner or an automatic controller.
