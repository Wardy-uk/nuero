...
- the WS3 build report at `saim/attractor/build_status/WS3-WP1.md`
- the WS3 evaluation report at `saim/attractor/eval_output/ws3_wp1_eval_2026-05-31.md`
- the telemetry-bridge artefacts under `saim/backend/`
