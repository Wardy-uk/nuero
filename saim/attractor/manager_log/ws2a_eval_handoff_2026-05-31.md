...
Use this standard only after the Build Agent has written `saim/attractor/build_status/WS2A-WP1.md`.
...
Write results to `saim/attractor/eval_output/` and report:
