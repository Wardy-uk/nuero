...
- the WS1 build report at `saim/attractor/build_status/WS1-WP1.md`
- the WS1 iteration build report at `saim/attractor/build_status/WS1-WP1-ITER1.md`
- the WS1 evaluation report at `saim/attractor/eval_output/ws1_wp1_eval_2026-05-31.md`
- the WS1 iteration evaluation report at `saim/attractor/eval_output/ws1_wp1_iter1_eval_2026-05-31.md`
...
- the `nuero` workspace is the authoritative SAiM programme workspace
