...
Connect a bounded set of Home Assistant telemetry signals into SAiM's shared state model through the existing provider/State Engine seam.

## Required Behavioural Outcome

Deliver a runtime where:

1. SAiM can read a bounded set of Home Assistant telemetry inputs
...
3. One factual build-status report in `saim/attractor/build_status/WS3-WP1.md`.
