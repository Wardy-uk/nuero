...
Build the first usable SAiM screen on the Pi 5 touchscreen while establishing a reusable many-views architecture over one shared state model.

## Required User-Visible Behaviour

1. SAiM can be launched from a Pi desktop icon or through clearly documented Pi-desktop installation instructions.
2. Mission Control v0 renders as the first SAiM view and feels usable on a 7-inch touchscreen.
