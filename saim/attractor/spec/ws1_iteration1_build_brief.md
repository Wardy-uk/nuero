...
This iteration is triggered by `saim/attractor/eval_output/ws1_wp1_eval_2026-05-31.md`.
...
Build against the SAiM runtime that exists in this repository under `saim/`.
...
- Preserve one SAiM / one shared model.
...
Write one factual iteration report to `saim/attractor/build_status/WS1-WP1-ITER1.md` that states:
