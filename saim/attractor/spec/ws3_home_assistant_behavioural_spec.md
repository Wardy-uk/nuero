...
Introduce Home Assistant as the telemetry ingestion layer for SAiM without making it the decision engine and without coupling the work to screen delivery.

## Required User-Visible Behaviour

1. The SAiM runtime can ingest a bounded set of Home Assistant telemetry signals.
