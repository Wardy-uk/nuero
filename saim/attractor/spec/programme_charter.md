# SAiM Programme Charter

## Purpose

Create SAiM as a persistent, context-aware personal operating layer with one shared understanding of Nick's world across embodiments.

## Protected Architectural Decisions

### Principle 1 — One SAiM

There is one SAiM brain and one shared state model.
...
SAiM’s UI must be view-based and interchangeable.
