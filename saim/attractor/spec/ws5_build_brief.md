...
Implement the first bounded context-inference slice over the converged SAiM state and telemetry seam.

## Required Behavioural Outcome

Deliver a runtime where:

1. SAiM exposes an inferred current context/activity state
2. SAiM exposes a recommended view
...
3. One factual build-status report in `saim/attractor/build_status/WS5-WP1.md`.
