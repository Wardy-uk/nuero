 ...
 * `enableNotifications()`, which the SAiM Controls screen calls when Nick turns
...
export function pushUnsupportedReason() {
  ...
  if (window.saimNative) return 'The desktop app can’t receive push notifications — your phone gets them.';
