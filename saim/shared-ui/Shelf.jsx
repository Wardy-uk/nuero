...
//
// Bottom-right in the Approach layout, and the contract is `saim/MANIFESTATION.md`:
...
//     and it answers an OFFER key, so a light SAiM has not offered is a
...
export default function Shelf({
  ...
  // laptop SAiM cannot see — asleep, off, or off the tailnet — which is not the
