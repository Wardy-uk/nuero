...
// Field — SAiM's presence on the phone.
//
// She is not an object. There is no orb, no avatar, no face, no glyph, no
// single bright point you could call "where SAiM is" — `MANIFESTATION.md`
// deprecates every one of those permanently, and it is right to. What you see
// is Nick's vault as a PINNED, noisy substrate, and SAiM visible only as
...
// ── Presence ────────────────────────────────────────────────────────────────
//
// Nick, 31 Aug 2026: "crank up the visibility of SAiM's presence — I always
...
// "Whenever I see SAiM" is satisfied by a static field; it is not satisfied by a
