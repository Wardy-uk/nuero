...
// The offline outbox lives there (`saim/app/src/mobile/localStore.js`) and holds
...
export default function RefreshButton({ buildLabel }) {
  ...
  return (
    <div className="refreshnav">
      {phase !== 'idle' && (
        <div className="refreshnav__panel" role="dialog" aria-label="Refresh SAiM">
