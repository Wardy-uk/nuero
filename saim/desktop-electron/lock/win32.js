...
// (Logic mirrors the standalone watch-lock tool, now living inside SAiM.)
...
const WAKE_PS = [
  "Add-Type -Namespace SaimNative -Name U -MemberDefinition '[DllImport(\"user32.dll\")] public static extern void mouse_event(uint f,uint dx,uint dy,uint d,System.IntPtr e);';",
  '[SaimNative.U]::mouse_event(1,1,0,0,[System.IntPtr]::Zero);',
  'Start-Sleep -Milliseconds 40;',
  '[SaimNative.U]::mouse_event(1,4294967295,0,0,[System.IntPtr]::Zero);',
].join(' ');
