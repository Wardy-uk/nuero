#!/bin/bash
# Put SAiM back in front on the Android kiosks, when something else took the screen.
#
# ⚠ WHY THIS EXISTS. Nick, 12 Sep 2026: "restart Saim on the p30 — its back to
# the sensor page again." The P30 runs BOTH the room sensor app and Fully Kiosk
# showing SAiM, and the sensor's persistent notification opens its own
...
# visit, an app update) leaves SAiM hidden until someone drives ADB by hand.
#
