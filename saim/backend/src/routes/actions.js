...
// AHEAD of it, forwarding approve/reject to NEURO with SAiM's own credential. On a
...
// resolve to a canonical attention record. `saimState` tries the record first
