// SAiM Context Inference — v0 (WS5-WP1).
//
// Protected principle: there is ONE SAiM and ONE shared state model, and the State
...
//   1. "what does SAiM think Nick is doing right now?" (a bounded activity/context)
//   2. "which view would SAiM recommend?" (advisory only)
...
// SAIM_VIEWS registry (frontend/src/state/views.js); kept as a small backend-local
...
// The bounded activity/context enum. Each value is one honest label for what SAiM
