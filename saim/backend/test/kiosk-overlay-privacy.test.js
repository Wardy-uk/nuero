...
// none`, so SAiM stayed fully usable underneath it — invisible, but tappable. The
// lock overlay was always opaque to input. saim/frontend has no test runner, so the
...
test('the clock overlay swallows taps instead of passing them to SAiM underneath', () => {
