...
// credential stays in `saim/backend` and the same views reach NEURO through
// this route.
//
...
test('positive control — an allowed door reaches NEURO, with SAiM\u2019s credential', async () => {
