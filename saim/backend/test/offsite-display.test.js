// A SAiM screen that is NOT in the house — Nick's desk at work (12 Sep 2026).
//
// "Amend SAiM's rules to accommodate it — lock the home devices, not the office."
//
...
test('at the desk, SAiM shows — even though the house says he is away', () => {
...
test('an unreadable desk sensor falls to the clock, not to SAiM', () => {
