# SAiM V1.5 — Claude Code Bootstrap Prompt

Paste this as your opening message when you open the NEURO repo in Claude Code:

---

Read CLAUDE-SAiM.md and SAiM-IOS-PROJECT.md before doing anything.

This is SAiM V1.5 — we're enhancing the existing NEURO PWA with SAiM's personality and a redesigned UX. The backend stays untouched. We're only changing the frontend and the system prompt sent to Ollama.
...
Then give me a brief summary of what exists and a proposed plan for applying SAiM V1.5 in phases, starting with the system prompt personality change and the Briefing (home) screen.
